...
function HomeContent({ initialIsAuthenticated }: { initialIsAuthenticated: boolean }) {
  ...
  useEffect(() => {
    // Initial auth state comes from the server (see page.tsx) - only
    // subscribe here for changes that happen after the page has loaded
    // (sign in/out in another tab, token refresh, etc).
...
export default function HomeClient({
  ...
  return (
    ...
    >
      <HomeContent initialIsAuthenticated={initialIsAuthenticated} />
    </Suspense>
  );
}
